...
from transformers import (AutoConfig, AutoModel, AutoModelForCausalLM, PreTrainedModel, GenerationMixin, VisionEncoderDecoderModel, VisionEncoderDecoderConfig, EncoderDecoderModel, EncoderDecoderConfig)
